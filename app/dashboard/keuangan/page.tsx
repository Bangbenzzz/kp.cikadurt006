  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%', maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      <style jsx global>{`
          ...
          /* --- FIX PENTING UNTUK HP (MOBILE) --- */
          /* Menghilangkan paksaan tinggi (height) dan overflow pada kartu di HP */
          /* Sehingga kartu akan memanjang ke bawah mengikuti isi, tanpa scrollbar internal */
      ...
      {/* LIST RIWAYAT (Dengan Fix Scroll Mobile) */}
      <div className="neon-card scroll-card-fix" style={{'--c1': '#444', '--c2': '#666'} as React.CSSProperties}>
          {/* Card inner akan otomatis menyesuaikan tinggi di HP (height: auto) */}
