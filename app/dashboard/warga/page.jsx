...
export default function WargaPage() {
  ...
  // --- FUNGSI SYNC (SIMPAN, UPDATE, DELETE) KE SPREADSHEET ---
  ...
  const handleExportPDF = () => {
      ...
      logo.onload = () => {
          ...
          autoTable(doc, {
              ...
              columnStyles: { 0: { cellWidth: 10, halign: 'center' }, 1: { cellWidth: 35, halign: 'center' }, 2: { cellWidth: 35, halign: 'center' }, 3: { cellWidth: 'auto' }, 4: { cellWidth: 25 }, 5: { cellWidth: 35 }, 6: { cellWidth: 10, halign: 'center' }, 7: { cellWidth: 12, halign: 'center' }, 8: { cellWidth: 20, halign: 'center' }, 9: { cellWidth: 20, halign: 'center' }, 10: { cellWidth: 12, halign: 'center' }, 11: { cellWidth: 25 }, 12: { cellWidth: 25, halign: 'center' }, 13: { cellWidth: 14, halign: 'center' }, 14: { cellWidth: 35 }, 15: { cellWidth: 30 } },
        ...
        <div style={{ overflowX: 'auto', background: "rgba(10,10,10,0.4)", borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)', marginBottom: '1rem' }}>
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, minWidth: '1800px', fontSize: '0.8rem' }}>
                ...
                <tbody>
                    {loading ? ( 
                        <tr>
                            <td colSpan="18" style={{textAlign: 'center', padding: '2rem', color: '#555'}}>Memuat data...</td>
                        </tr> 
