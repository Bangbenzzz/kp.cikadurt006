...
export default function WargaPage() {
  ...
  const handleDelete = async () => {
      if(modalState.data?.id) {
          try {
              ...
              showToast("Data berhasil dihapus (Web & Backup)", 'success');
          } catch(e) { 
              console.error(e);
  ...
  const handleExportPDF = () => {
      ...
      logo.onload = () => {
          ...
          const tableColumn = [ "No", "No KK", "NIK", "Nama Lengkap", "Hub. Keluarga", "Alamat", "RT", "RW", "Jenis Kelamin", "Agama", "Gol", "Tmpt Lahir", "Tgl Lahir", "Usia", "Pendidikan", "Pekerjaan" ];
  ...
  const handleExportExcel = async () => {
    ...
    headerRow.values = [ "No", "No KK", "NIK", "Nama Lengkap", "Hub. Keluarga", "Alamat", "RT", "RW", "Jenis Kelamin", "Agama", "Gol", "Tmpt Lahir", "Tgl Lahir", "Usia", "Pendidikan", "Pekerjaan", "Kategori" ];
